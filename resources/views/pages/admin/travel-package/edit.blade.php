    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('travel-package.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="type_travel">Other Travel</label>
                    {{-- <input type="text" class="form-control" name="type" placeholder="Type" value="{{ old('type') }}"> --}}
                    <select class="form-control" name="type_travel" id="type_travel" >
                        <option value="bookperday" {{ $item->type_travel == 'bookperday' ?  'selected' : ''}}>Booking Per Day</option>
                        <option value="more" {{ $item->type_travel == 'more' ?  'selected' : ''}} >More</option>
                    </select>
                </div>
                <div class="form-group">
